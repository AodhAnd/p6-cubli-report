...
\end{flalign}
In the case of this plant, the number of poles in the RHP is one and there are no encirclements of -1 (\figref{nyquistCubli}), which means that the total number of zeros in the RHP is 1. As this zero will be a pole in the closed loop system the system is confirmed as unstable.

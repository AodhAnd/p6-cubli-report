...
In the case of the plant, the number of poles in the RHP is one and there is no circle surrounding -1 on \figref{nyquistCubli}, which means that the total number of zeros in the RHP is 1, thus the system is confirmed as unstable.

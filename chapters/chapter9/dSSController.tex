...
The final combination of poles is -6, -7 and -10, which gives the yellow responses in \figref{disturbanceStateSpace} and \figref{catchingStateSpace}, since its response is quite fast but with not too much overshoot. The gain matrix for this combination results in the following:
%

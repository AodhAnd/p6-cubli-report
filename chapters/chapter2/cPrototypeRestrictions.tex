...
With only one frame, the prototype cannot spin around itself nor move as described in \secref{sec:protoRestrictions}. Instead of balancing up in two steps, the frame can only balance on its corner which is comparable to getting the cube to balance on its edge.\\

...
The linearized model is considered valid within the discussed range of angles (\si{\pm 0,79\ rad}), so it can be used to do a deeper analysis on the behavior of the system.\fxnote{argument is missing its source or data for validation since previous data is vs nonlinear} %This includes evaluations in frequency domain, s-domain and L(s)-domain.

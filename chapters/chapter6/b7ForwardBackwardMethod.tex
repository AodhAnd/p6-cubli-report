...
\begin{minipage}{\linewidth}
	...
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\centering
			\captionsetup{justification=centering}
			\captionof{figure}{Zoom on the convergence shows how the gradient descent method create a pattern with almost orthogonal lines converging to the minimum, (43 iterations are shown).\vspace{50pt}}

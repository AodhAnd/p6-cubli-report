...
\begin{minipage}{\linewidth}
	...
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\centering
			\captionsetup{justification=centering}
			\captionof{figure}{Zoom on the convergence shows how the gradient descend method create a pattern of lines converging to the minimum.\vspace{50pt}}
...
The result can be seen in \figref{paramEstFibonacci}, which gives \si{J_F=4,8 \cdot 10^{-3}\ kg \cdot m^2} and \si{B_F=7,8 \cdot 10^{-3}\ m \cdot s \cdot rad^{-1}}.

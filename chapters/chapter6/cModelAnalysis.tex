...
From \figref{LinearizedVSNonlinear} and \figref{LinearizedVSNonlinear_0}, the linearized model is considered a good approximation of the system's behavior in the operational region of \si{\pm 0,79\ rad}.

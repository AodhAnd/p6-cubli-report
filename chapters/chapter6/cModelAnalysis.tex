...
\begin{minipage}{\linewidth}
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\centering
			\captionsetup{justification=centering}
			\captionof{figure}{Comparison of test and model of frame falling from equilibrium position}
	...
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\centering
			\captionsetup{justification=centering}
			\captionof{figure}{Comparison of test and model of frame falling from initial condition \si{-10^\circ}}
...
In an attempt to avoid unjustified assumptions the test is repeated from initial condition \si{-10^\circ} in both simulation and test, the result is shown in \figref{FallTestComparison10deg}.

...
The ADC's of the BeagleBone have a 12-bit resolution that is limited to a range of \si{0 - 1,8 V}\fxnote{Tjek if this was set correctly}. Sampling time is 125ns \cite{Cameon}
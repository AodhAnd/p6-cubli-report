...
This board is used for power distribution with different voltages sent to each unit. There is also a built-in gain for the potentiometer, configured for the range of the BeagleBone ADC's and the possible positions that the frame can have. The schematics can be found in \appref{app:ConnectingBreakoutBoard}.

...
Simon Jensen, Electronic Technician at Aalborg University, has made the connecting and breakout board. The text on the board is Automation \& Control made by Simon Jensen 2C 94V-0 15/01.\fxnote{Do we need all this information ? J.} The Schematic of the connecting and breakout board can be found in the appendix.\fxnote{Schematic in appendix}
...
The corresponding part used on the Cubli setup is a Hitec HS225 Mighty Mini Servomotor.\fxnote{Add reference}

...
It is also needed to find the conversion from voltage to angle along with potential offset, so a test is carried out as can be seen in \appref{app:potentiometerRes}.

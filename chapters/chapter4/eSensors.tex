...
=======
Since the tests and feedback are depending on the reliability of the potentiometer, different tests are carried out on the potentiometer.
...
>>>>>>> 67893327996036f45080efe8cc1ada5626f4d6f7
Test to find the voltage to angle conversion along with potential offset, see \appref{app:potentiometerRes}.

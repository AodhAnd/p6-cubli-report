...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.55]{figures/openLoopBadSISOController}
...
However, pre-warping should improve the matching between the discretized version and the continuous version of the controller, by re-mapping frequencies to reduce the bilinear transform's distortion.\\

\chapter{Complementary filter} \fxnote{different chapter names, since this might be more of a chapter how to get IMU working than just about complementary filter?, B}

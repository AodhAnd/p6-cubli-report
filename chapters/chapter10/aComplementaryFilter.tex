...
An test to measure the angle of the cubli frame \si{\theta_F} is performed with the accelerometer and potentiometer and comparison of the data is shown in \figref{angleAcc}. The accelerometer angle was found by taking the x- and y-axis components and calculating the angle with \eqref{accelAngle}

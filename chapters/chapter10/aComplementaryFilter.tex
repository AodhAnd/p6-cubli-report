...
The position is calculated through the function \lstinline{getPosition()}. \\
...
The old values from \lstinline{accel_angle}, \lstinline{gyro_angle} and \lstinline{comp_angle} are moved up in their arrays and new data is saved in \lstinline{gyro_angle} and \lstinline{accel_angle} on index 0. \\

...
As described in \secref{sec:Sensors}\fxnote{get the correct reference to the picture in system describtion} there are two IMUs mounted on the frame of the Cubli. They can be used to achieve this goal since they only depend on the absolute angle and they can also be used in the full Cubli.

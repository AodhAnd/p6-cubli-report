...
\begin{figure}[H]
	...
	\caption{Bode diagrams of the high pass and low pass filters from the complementary filter as well as the summation of both filters to show the resulting gain of the angle}
	\label{bodeFilters}
\end{figure}\vspace{-5mm}
%

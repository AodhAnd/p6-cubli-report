...
As shown in the figure the angle can be found using \eqref{accelAngle}. The offset is added because the IMU is mounted with a \si{\frac{\pi}{4}} rotation compared to the orientation of the frame.
%
\begin{flalign}

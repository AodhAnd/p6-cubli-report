\chapter{Fall Response}\label{fallResposneAppendix} 
...
\begin{minipage}{\linewidth}
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\captionof{figure}{Graph over fallresponse from \si{0^\circ}. Y-axis is voltage}
			\label{graphFallResponsVoltDeg0}
	...
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\vspace{-.4cm}
			\captionsetup{justification=centering}
			\captionof{figure}{Graph over fallresponse from \si{0^\circ}. Y-axis is radians}
			\label{graphFallResponsRadDeg0}
		\end{figure}\vspace{-5mm}
	\end{minipage}
...
\begin{minipage}{\linewidth}
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\vspace{-.4cm}
			\captionsetup{justification=centering}
			\captionof{figure}{Graph over fallresponse from \si{-10^\circ}. Y-axis is voltage}
			\label{graphFallResponsVoltDeg10}
		\end{figure}\vspace{-5mm}
	\end{minipage}
	\hspace{0.03\linewidth}
	\begin{minipage}{0.45\linewidth}
		\begin{figure}[H]
			...
			\vspace{-.4cm}
			\captionsetup{justification=centering}
			\captionof{figure}{Graph over fallresponse from \si{-10^\circ}. Y-axis is radians}
			\label{graphFallResponsRadDeg10}
		\end{figure}\vspace{-5mm}
	\end{minipage}
\end{minipage} \fxnote{Look at the layout of picture of data placement}

...
legend('Continuous controller (CL)','Discretized Controller (ZOH) (CL)','Discretized Controller (Tustin) (CL)','Discretized Controller (Tustin with Pre-Warping) (CL)','Location','Southeast');
